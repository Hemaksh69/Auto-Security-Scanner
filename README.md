...
Create your feature branch (git checkout -b feat/new-check).

Run make verify to check logic.

Open a Pull Request.

<div align="center">

Built for engineers who believe security belongs in the pipeline. ⭐ Star this repository to support the project!
